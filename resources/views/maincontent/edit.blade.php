...
@section('content')
<div class="">
    <form action="/maincontent/{{ $content->id }}" enctype="multipart/form-data" method="post">
        ...
        <div class="containerDiv">
            <div class="">
                ...
                <div class="indivElem formSlide">
                    ...
                    name="heading1" placeholder="Heading line 1" value="{{ old('heading1') ?? $content->heading1 }}" 
                    ...
                    name="heading2" placeholder="Heading line 2 (optional)" value="{{ old('heading2') ?? $content->heading2}}" 
                    ...
                    name="heading3" placeholder="Heading line 3 (optional)" value="{{ old('heading3') ?? $content->heading3 }}" 
                ...
                <div class="indivElem formSlide">
                    ...
                    name="innercontent" value="{{ old('innercontent') ?? $content->innercontent}}" 
                ...
                <div class="indivElem formSlide">
                    ...
                    name="navigatebutton" value="{{ old('navigatebutton') ?? $content->navigatebutton}}" 
                ...
                <div class="indivElem formSlide">
                    ...
                    name="navigatetext" value="{{ old('navigatetext') ?? $content->navigatetext }}" 
                ...
                <div class="indivElem formSlide">
                    <label for="image" class="">Background image Optional</label><br>
                ...
                <div class="actionButton">
                    <button class="contact">Edit Slides</button>
                </div>
            </div>
        </div>
